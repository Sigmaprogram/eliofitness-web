            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <MapPin size={24} className="text-red-600 mr-4 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start">
                  <Phone size={24} className="text-red-600 mr-4 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start">
                  <Mail size={24} className="text-red-600 mr-4 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold mb-2">Email</h3>
                    <p className="text-zinc-400">
                      info@fitnesselite.com<br />
                      soporte@fitnesselite.com
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  <Clock size={24} className="text-red-600 mr-4 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold mb-2">Horario</h3>
                    <p className="text-zinc-400">
                      Lunes - Viernes: 6:00 - 23:00<br />
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input type="text" id="apellidos" className="form-input" placeholder="Tus apellidos" required />
                  </div>
                </div>
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-4">
          <div className="relative h-[400px] rounded-lg overflow-hidden">
            <Image
              src="https://i0.wp.com/blog.smartfit.com.mx/wp-content/uploads/2021/05/gimnasios-definicion-e-historia-1.jpg?fit=1200%2C675&ssl=1"
